  ...
  void (async () => {
    ...
    try {
      if (isGreeting(latest.content)) {
        await writeEvent(writer, "token", { token: "Hello, welcome to Strive Africa. I can help with programmes, destinations, approved listed fees, applications, career guidance, visa centre, flight bookings, student journeys, the study guide and contact details. What would you like to know?" });
